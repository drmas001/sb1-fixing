  ...
  const filteredData = specialtiesData
    ...
    .map(specialty => ({
      ...
      patients: specialty.patients.filter(patient =>
        ...
        (selectedDate ? formatDate(patient.admission_date) === formatDate(selectedDate) : true)
      )
    }));
              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {sortedData(specialty.patients).map((patient) => (
                    <tr key={`${patient.mrn}-${patient.admission_date}`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-500">{formatDateTime(patient.admission_date)}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
